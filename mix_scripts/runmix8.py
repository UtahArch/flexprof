...
#['lu', 'perl', 'dc', 'sp', 'gcc', 'omnetpp', 'xalanc']
cmd1 = f"python3 pattern_finder.py 0/100 0/100 0/100 0/100 0/100 5/100 0/100 input/patterns/runmix8.8pattern {banks[0]}"
processes.append(subprocess.Popen(cmd1, shell=True))
time.sleep(2) 
cmd2 = (f"bin/usimm-fsbta-rwopt {input_file} "
        f"input/mix8/lu0 input/mix8/perl1 "
        f"input/mix8/dc2 input/mix8/sp3 "
        f"input/mix8/gcc4 input/mix8/omnetpp5 "
        f"input/mix8/xalanc6 "
        f"input/patterns/runmix8.8pattern > {output_folder}/rwopt-runmix8")
