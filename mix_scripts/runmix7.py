...
#['omnetpp', 'mg', 'cg', 'perl', 'ep', 'bt', 'mcf']
cmd1 = f"python3 pattern_finder.py 5/100 0/100 0/100 0/100 1/100 0/100 0/100 input/patterns/runmix7.8pattern {banks[0]}"
processes.append(subprocess.Popen(cmd1, shell=True))
time.sleep(2) 
cmd2 = (f"bin/usimm-fsbta-rwopt {input_file} "
        f"input/mix7/omnetpp0 input/mix7/mg1 "
        f"input/mix7/cg2 input/mix7/perl3 "
        f"input/mix7/ep4 input/mix7/bt5 "
        f"input/mix7/mcf6 "
        f"input/patterns/runmix7.8pattern > {output_folder}/rwopt-runmix7")
