...
token_t tokenize(char *input) {
  ...
  } else if (strncmp(input, "DOMAINS", length) == 0) {
    return domain_token;
  } else if (strncmp(input, "D1_WR_RATIO", length) == 0) {
    return d1;
  } else if (strncmp(input, "D2_WR_RATIO", length) == 0) {
    return d2;
  } else if (strncmp(input, "D3_WR_RATIO", length) == 0) {
    return d3;
  } else if (strncmp(input, "D4_WR_RATIO", length) == 0) {
    return d4;
  } else if (strncmp(input, "D5_WR_RATIO", length) == 0) {
    return d5;
  } else if (strncmp(input, "D6_WR_RATIO", length) == 0) {
    return d6;
  } else if (strncmp(input, "D7_WR_RATIO", length) == 0) {
    return d7;
  } else if (strncmp(input, "D8_WR_RATIO", length) == 0) {
    return d8;
  } else if (strncmp(input, "D9_WR_RATIO", length) == 0) {
    return d9;
  } else if (strncmp(input, "D10_WR_RATIO", length) == 0) {
    return d10;
  } else if (strncmp(input, "D11_WR_RATIO", length) == 0) {
    return d11;
  } else if (strncmp(input, "D12_WR_RATIO", length) == 0) {
    return d12;
  }
